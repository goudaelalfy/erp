...
<form id="frm_display_data" name="frm_display_data" action="<?php echo base_url();?>ums/users/submit_display" method="post">

<table >
	<tr height="50px" valign="top">
		<td width="100px"><a href="<?php echo base_url();?>ums/users/go_form/0/add"><img src='<?php echo base_url()."/images/icons/add.gif"; ?>' width='33'; height='33' title='<?php  echo $this->lang->line('btn_add'); ?>'/></a></td> 
