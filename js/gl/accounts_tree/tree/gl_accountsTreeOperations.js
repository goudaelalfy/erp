...
////////////////////////////////////////////////////// By Gouda ///////////////////
	...
	{    
		...
		var newwindow=window.open('gl/accounts_tree/go_form/add/'+parent_id,'Add Gl Accounts','width=600px,height=450px,toolbar=no,sizeable=0,  directories=no,status=yes,menubar=no,scrollbars=yes,copyhistory=yes');
...
//////////////////////////////////////////////////////////////////////////////////
	...
	this.updateElementNameReq = function()
	{
		...
		var newwindow=window.open('gl/accounts_tree/go_form/edit/'+id,'Add Gl Accounts','width=600px,height=450px,toolbar=no, sizeable=0,  directories=no,status=yes,menubar=no,scrollbars=yes,copyhistory=yes');
		if (window.focus) {newwindow.focus();}
